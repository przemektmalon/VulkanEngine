...
VkFormat PhysicalDeviceDetails::findSupportedFormat(const std::vector<VkFormat>& candidates, VkImageTiling tiling, VkFormatFeatureFlags features)
{
	...
	DBG_SEVERE("Failed to find supported format");
}

VkFormat PhysicalDeviceDetails::findDepthFormat()
{
