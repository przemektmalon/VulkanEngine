...
class CombineOverlaysShader : public ShaderProgram
{
public:
	CombineOverlaysShader() : vertexModule(ShaderModule::Vertex, "/res/shaders/combineOverlays.glsl"), fragmentModule(ShaderModule::Fragment, "/res/shaders/combineOverlays.glsl") {}
